...
fetch('https://api.openweathermap.org/data/2.5/forecast?q='+newName.value+'&appid=ee0f9a588c4aa47825e2a42bb3f4672f')
...
function DefaultScreen(){
    document.getElementById("cityInput").defaultValue = "Flagstaff";
    GetInfo();
}
